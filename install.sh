#!/usr/bin/env sh
# Universal installer for readiness-rms. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/readiness-rms.git"
echo "Installing readiness-rms ..."
...
echo "Done. Run: readiness-rms --help"
